            ...
            BEGIN
                ...
                INSERT  INTO [RealizacijaPoDobaviteljih]
                        ...
                        WHERE   M.[Interval] >= @DatumIntervalaOD
                                ...
                                AND @DatumStanjaBaze BETWEEN PPM.DatumVnosa  AND dbo.infinite(PPM.DatumSpremembe) 
                                AND @DatumVeljavnostiPodatkov BETWEEN PPM.VeljaOd AND dbo.infinite(PPM.VeljaDo)
...
--                                                                             AND RPD.[ObracunID] = @NewObracunID
--                        WHERE   [RealizacijaPoDobaviteljih].[Nivo] = @maxNivo   - 1
--								AND RealizacijaPoDobaviteljih.[ObracunID] = @NewObracunID
...
--            END
            	...
            	/*KOREKT MEJE*/
							...
							UPDATE K
							SET K.[Kolicina] = -1*K.[Kolicina]
							FROM [dbo].[RealizacijaPoDobaviteljih] K 
							JOIN [dbo].[OsebaZCalc] ZC ON K.OsebaID = ZC.[OsebaID]
